          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-14">
              <Link to="/" className="flex items-center space-x-2">
                <span className="text-xl font-bold text-white">PurePath</span>
              </Link>
              <nav className="flex items-center space-x-4">
                <Link to="/" className="text-sm text-cyan-400 hover:text-cyan-300">
                  Route Planner
                </Link>
                <Link to="/about" className="text-sm text-slate-400 hover:text-white">
                  About
                </Link>
                <a
      ...
      {!isHome && (
        <footer className="bg-slate-900 border-t border-slate-800 py-4">
          <div className="max-w-7xl mx-auto px-4 text-center">
            <p className="text-slate-500 text-xs">PurePath - AI-Powered Pollution-Aware Navigation</p>
          </div>
        </footer>
      )}
    </div>
